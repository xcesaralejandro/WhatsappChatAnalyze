...
class Counter:
    ...
    def summary(self):
        print("\n\nMensajes enviados =>",self.__messages)
        ...
        print("\nTotal de palabras escritas =>",self.__message_words)
        print("\nMensajes multimedia enviados (stickers, adjuntos) =>",self.__message_multimedia)
        summary = { 
            "Mensajes enviados" : self.__messages,
            "Mensajes multimedia enviados(stickers, adjuntos)" : self.__message_multimedia,
            "Total de palabras escritas" : self.__message_words,
